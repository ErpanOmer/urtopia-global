...
class CartItems extends HTMLElement {
  ...
  onChange(event) {
   ...
   if(data.type.indexOf("Carbon One")>-1)
   {
     var accessoriesNum = {hNum:Number(data.hnum),bNum:Number(data.bnum),bikeID:data.id}
     this.updateQuantityLabour(data.index, event.target.value, document.activeElement.getAttribute('name'),accessoriesNum);
   }
  ...
  updateQuantityLabour(line,quantity,name,allQuantity){
    ...
    console.log("wwwww",`${routes.cart_update_url}`)
